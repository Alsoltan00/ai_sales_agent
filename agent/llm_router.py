...
def generate_sales_reply(user_message: str, filtered_products: list, chat_history: list = None, store_name: str = "المتجر", system_prompt_custom: str = None) -> str:
    ...
    5. الالتزام والهلوسة: لا تخترع معلومات أو منتجات غير موجودة في البيانات المرفقة أبداً. استخدم سياق المحادثة السابقة بذكاء لفهم ما يقصده العميل إذا كانت رسالته قصيرة جداً (مثال: إذا قال "رقم 1" أو "أعطني 5"، فهو يقصد المنتج الذي تحدثتم عنه للتو).
    """
