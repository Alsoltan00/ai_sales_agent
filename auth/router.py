...
<script>window.location.href = '/merchant/dashboard-test';</script>
</head><body style="background:#0f172a;color:white;text-align:center;padding:50px;">
<h2>جاري تحويلك للوحة التحكم...</h2>
<p>إذا لم يتم التحويل تلقائياً، <a href="/merchant/dashboard-test" style="color:#f59e0b;">اضغط هنا</a></p>
</body></html>"""
